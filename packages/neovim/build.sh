...
-DPC_LUAJIT_LIBRARY_DIR=$TERMUX_PREFIX/lib
...
termux_step_host_build() {
	...
	make CMAKE_EXTRA_FLAGS="-DCMAKE_INSTALL_PREFIX=$TERMUX_PKG_HOSTBUILD_DIR -DUSE_BUNDLED_LUAROCKS=ON -DUSE_BUNDLED_LUAJIT=OFF" install
	make distclean
	rm -Rf build/
}
