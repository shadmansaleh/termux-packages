...
-DCMAKE_INSTALL_PREFIX=$TERMUX_PKG_SRCDIR
...
-DLUAJIT_INCLUDE_DIR=$TERMUX_PKG_HOSTBUILD_DIR/usr/include/luajit-2.1
-DLUAJIT_LIBRARY=$TERMUX_PKG_HOSTBUILD_DIR/lib/libluajit-5.1.a 
"
